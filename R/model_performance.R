...
#' plotGridSearchPerplexity(celda.CG.grid.search.res)
#' @export
plotGridSearchPerplexity.celda_CG = function(celda.list, sep) {
  ...
  if(nlevels(df$K) > 1) {
    plot = ggplot2::ggplot(df, ggplot2::aes_string(x="K", y="perplexity")) +
      ...
      ggplot2::xlab("K") +
      ggplot2::scale_x_discrete(breaks = seq(min(celda.list@run.params$K), max(celda.list@run.params$K), sep)) +
      ggplot2::theme_bw()
  } else {
    plot = ggplot2::ggplot(df, ggplot2::aes_string(x="L", y="perplexity")) +
      ...
      ggplot2::ylab("Perplexity") +
      ggplot2::xlab("L") +
      ggplot2::scale_x_discrete(breaks = seq(min(celda.list@run.params$L), max(celda.list@run.params$L), sep)) +
      ggplot2::theme_bw()
  }
...
#' plotGridSearchPerplexity(celda.CG.grid.search.res)
#' @export
plotGridSearchPerplexity.celda_C = function(celda.list, sep) {
...
#' plotGridSearchPerplexity(celda.CG.grid.search.res)
#' @export
plotGridSearchPerplexity.celda_G = function(celda.list, sep) {
