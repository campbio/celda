...
#' @seealso \code{\link{celda_C}} for cell clustering and \code{\link{celda_CG}} for simultaneous clustering of features and cells. \code{\link{celdaGridSearch}} can be used to run multiple values of L and multiple chains in parallel. 
#' @examples
