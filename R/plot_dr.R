...
#'  This matrix should be the same as the one used to generate `celda.mod`.
...
#' @param xlab Character vector. Label for the x-axis. Default "Dimension_1".
#' @param ylab Character vector. Label for the y-axis. Default "Dimension_2".
#' @param specific_clusters Numeric vector.
#'  Only color cells in the specified clusters.
#'  All other cells will be grey.
#'  If NULL, all clusters will be colored. Default NULL.
#' @param label_clusters Logical. Whether the cluster labels are plotted.
#'  Default FALSE.
#' @param label_size Numeric. Sets size of label if label_clusters is TRUE.
#'  Default 3.5.
#' @return The plot as a ggplot object
#' @examples
#' \donttest{
...
# @param norm Normalized count matrix.
# @param umap.config An object of class umap.config,
