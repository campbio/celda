...
#'  `celda::buildTreeHybrid`
#' @description Esimate cell cluster membership using feature matrix input.
#' @param rules List object. The `rules` element from  `buildTreeHybrid`
...
# Function to get decisions for a matrix of features
