...
# This is a wrapper around set.seed called throughout the modeling functions to allow
# the user to disable seed setting within celda. This way, power users could set a seed
# externally to celda and have greater control (and more responsibility) over their
