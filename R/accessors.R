...
#'  \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} object or celda model
#'  object.
...
#'  only if \code{x} is a \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} object.
#' @return One of
#' \itemize{
...
#'  Works only if \code{x} is a \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} object.
...
#'  only is \code{x} is a \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} object.
...
#' @param x An object of class \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} or class
#'  \code{celdaList}.
#' @param altExpName The name for the \link[SingleCellExperiment]{altExp} slot
#'  to use. Default "featureSubset".
...
#' @param x An object of class \link[SingleCellExperiment:SingleCellExperiment-class]{SingleCellExperiment} or
#'  \code{celdaList}.
#' @param altExpName The name for the \link[SingleCellExperiment]{altExp} slot
#'  to use. Default "featureSubset".
