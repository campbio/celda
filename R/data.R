...
#' @description The result of running the calculatePerplexityWithResamplingfunction on the pbmc_res model
#' @format list
...
#' @description The result of running the calculatePerplexityWithResamplingfunction on the pbmc_res model. Done on K = 10:20, L = 10:50
#' @format list
#' @details Generated by Yusuke Koga
#' @source \url{http://github.com/compbiomed/celda}
"calc.perplexity2"