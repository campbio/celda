...
#' @examples
#' celda.mods = celda_CG(celda::pbmc_select, K=c(10,15), L=c(50, 100), max.iter=2, nchains=1)
...
#' @examples
#' celda.mods = celda_CG(celda::pbmc_select, K=c(5,10), L=c(10,20,30), max.iter=2, nchains=1)
