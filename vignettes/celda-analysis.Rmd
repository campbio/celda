...
Starting from a matrix of counts of transcripts (cells by transcripts). we will discuss the preliminary steps of normalization, and the creation of the celda object, the results are then analyzed through heatmaps and PCA. Once we are satisfied that we have high-quality expression, we will consider tests for __________ and ways to visualize results.  
...
plot(sim_counts$counts, main = "Simulated Cell Counts", xlab = "transcripts", ylab = "cells")
...
plot(norm.counts, main = "Normalized Simulated Cell Counts", xlab = "transcripts", ylab = "cells")
```
