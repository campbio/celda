...
```{r}
ct_markergenes = do.call(what = rbind, rgs = list(data.frame("celltype" = "Tcell", "markergenes"=c("CD3D", "CD3E")),
																									data.frame("celltype" = "Bcell", "markergenes"=c("MS4A1", "CD79A", "CD79B")),
																									data.frame("celltype" = "NKcell", "markergenes"=c("GNLY")),
																									data.frame("celltype" = "monocytes", "markergenes"=c("LYZ", "SA100A8", "SA100A9"))))
