...
```{r barplotBoth}
plotDecontXMarkers(pbmc4k, markers = markers, groupClusters = cellTypeMappings, assayName = c("counts", "decontXcounts"))
```

Some important considerations when using this barplot function:
